...
'dojox/dtl/filter/lists':function(){
define([
	"dojo/_base/lang",
	"../_base"
], function(lang,dd){
...
'dojox/dtl/filter/logic':function(){
define([
	"dojo/_base/lang",
	"../_base"
], function(lang,dd){
...
'*now':function(r){r(['dojo/i18n!*preload*dojo/nls/custom_layer*["ar","ca","cs","da","de","el","en-gb","en-us","es-es","fi-fi","fr-fr","he-il","hu","it-it","ja-jp","ko-kr","nl-nl","nb","pl","pt-br","pt-pt","ru","sk","sl","sv","th","tr","zh-tw","zh-cn","ROOT"]']);}
}});
define("dojo/custom_layer", [], 1);
