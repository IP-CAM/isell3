    ...
    <div class="no_print appbar" align="center">
        ...
        if ($export_types) {
            foreach ($export_types as $ext => $name) {
                ?>
                <div class="gray_grad" style="display:inline-block;padding:3px;font-size:12px;"><a href="<?php echo $_SERVER['REQUEST_URI'] . '&out_type=' . $ext ?>" style="color:#333;" title="Скачать"><?php echo $name ?><img src="img/down.png" width="24" height="24" border="0" align="absmiddle" /></a> <a href="javascript:sendemail('<?php echo $ext ?>')" style="color:black;font-size:12px;" title="Отправить по Email"><img src="img/email.png" width="24" height="24" border="0" align="absmiddle" /></a></div>
                <?php
            }
        }
        ?>
