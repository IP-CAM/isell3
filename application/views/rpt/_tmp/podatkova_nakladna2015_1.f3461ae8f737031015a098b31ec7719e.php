...
<?php } ?>
<?php $counter1=-1; if( isset($v["entries"]) && is_array($v["entries"]) && sizeof($v["entries"]) ) foreach( $v["entries"] as $key1 => $value1 ){ $counter1++; ?>
    <RXXXXG3S ROWNUM="<?php echo $counter1+1;?>"><?php echo $value1["product_name"];?></RXXXXG3S>
<?php } ?>
<?php $counter1=-1; if( isset($v["entries"]) && is_array($v["entries"]) && sizeof($v["entries"]) ) foreach( $v["entries"] as $key1 => $value1 ){ $counter1++; ?>
    <RXXXXG4 ROWNUM="<?php echo $counter1+1;?>"><?php echo $value1["product_uktzet"];?></RXXXXG4>
<?php } ?>
<?php $counter1=-1; if( isset($v["entries"]) && is_array($v["entries"]) && sizeof($v["entries"]) ) foreach( $v["entries"] as $key1 => $value1 ){ $counter1++; ?>
    <RXXXXG4S ROWNUM="<?php echo $counter1+1;?>"><?php echo $value1["product_unit"];?></RXXXXG4S>
<?php } ?>
<?php $counter1=-1; if( isset($v["entries"]) && is_array($v["entries"]) && sizeof($v["entries"]) ) foreach( $v["entries"] as $key1 => $value1 ){ $counter1++; ?>
    <RXXXXG105_2S ROWNUM="<?php echo $counter1+1;?>"><?php echo $value1["product_unit_code"];?></RXXXXG105_2S>
<?php } ?>
<?php $counter1=-1; if( isset($v["entries"]) && is_array($v["entries"]) && sizeof($v["entries"]) ) foreach( $v["entries"] as $key1 => $value1 ){ $counter1++; ?>
    <RXXXXG5 ROWNUM="<?php echo $counter1+1;?>"><?php echo $value1["product_quantity"];?></RXXXXG5>
<?php } ?>
<?php $counter1=-1; if( isset($v["entries"]) && is_array($v["entries"]) && sizeof($v["entries"]) ) foreach( $v["entries"] as $key1 => $value1 ){ $counter1++; ?>
    <RXXXXG6 ROWNUM="<?php echo $counter1+1;?>"><?php echo $value1["product_price"];?></RXXXXG6>
<?php } ?>
<?php $counter1=-1; if( isset($v["entries"]) && is_array($v["entries"]) && sizeof($v["entries"]) ) foreach( $v["entries"] as $key1 => $value1 ){ $counter1++; ?>
    <RXXXXG7 ROWNUM="<?php echo $counter1+1;?>"><?php echo $value1["product_sum"];?></RXXXXG7>
<?php } ?>
<?php $counter1=-1; if( isset($v["entries"]) && is_array($v["entries"]) && sizeof($v["entries"]) ) foreach( $v["entries"] as $key1 => $value1 ){ $counter1++; ?>
