...
CHANGE COLUMN `product_bpack` `product_bpack` INT(10) UNSIGNED NOT NULL COMMENT 'Мал. упак.' ,
CHANGE COLUMN `product_spack` `product_spack` INT(10) UNSIGNED NOT NULL COMMENT 'Бол. упак.' ,
