...
class AccountsProc extends iSellBase {

    public function AccountsProc() {
...
//            $view['c_reg'] = '08';
//            $view['c_raj'] = '32';
//            $view['tin'] = str_pad($view['a']['company_code'], 10, '0', STR_PAD_LEFT);
//            $view['c_doc'] = 'J12';
//            $view['c_doc_sub'] = '015';
//            $view['c_doc_ver'] = '7';
//            $view['c_doc_stan'] = '1';
//            $view['c_doc_type'] = '00';
//            $view['c_doc_cnt'] = str_pad(1, 7, '0', STR_PAD_LEFT);
//            $view['period_type'] = '1';
//            $view['period_month'] = substr($period, 5, 2);
//            $view['period_year'] = substr($period, 0, 4);
//            $view['c_sti_orig'] = $view['c_reg'] . $view['c_raj'];
//            $filename = $view['c_reg'] . $view['c_raj'] . $view['tin']
//                    . $view['c_doc'] . $view['c_doc_sub']
//                    . str_pad($view['c_doc_ver'], 2, '0', STR_PAD_LEFT) . $view['c_doc_stan'] . $view['c_doc_type']
//                    . $view['c_doc_cnt'] . $view['period_type'] . $view['period_month'] . $view['period_year'] . $view['c_sti_orig'] . '.xml';
            $this->LoadClass('Pref');
            ...
            $this->LoadClass('FileEngine');
            $this->FileEngine->assign($view, 'xml/reestr_podatkovih_2014.xml');
